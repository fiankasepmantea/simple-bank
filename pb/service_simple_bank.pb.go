...
const file_service_simple_bank_proto_rawDesc = "" +
	"\n" +
	"\x19service_simple_bank.proto\x12\x02pb\x1a\x1cgoogle/api/annotations.proto\x1a\x15rpc_create_user.proto\x1a\x14rpc_login_user.proto\x1a.protoc-gen-openapiv2/options/annotations.proto2\xc4\x02\n" +
	"\n" +
	"SimpleBank\x12\x8f\x01\n" +
	"\n" +
	"CreateUser\x12\x15.pb.CreateUserRequest\x1a\x16.pb.CreateUserResponse\"R\x92A5\x12\x0fCreate new user\x1a\"Use this API to create a new user.\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/v1/create_user\x12\xa3\x01\n" +
	...
	"\x0ffiankasepmantea\x12.https://github.com/fiankasepmantea/simple-bank\x1a\x13fianet341@gmail.com2\x031.1Z\x0esimple-bank/pbb\x06proto3"
